 ...
 * @deprecated Use {@link RestatePromise}
 */
type CombineablePromise<T> = RestatePromise<T>;
declare const createServiceHandler: typeof handlers.handler;
declare const createObjectHandler: typeof handlers.object.exclusive;
declare const createObjectSharedHandler: typeof handlers.object.shared;
declare const createWorkflowHandler: typeof handlers.workflow.workflow;
declare const createWorkflowSharedHandler: typeof handlers.workflow.shared;
//#endregion
export { CombineablePromise, type Duration$1 as Duration, type JournalValueCodec$1 as JournalValueCodec, type ObjectHandler$1 as ObjectHandler, type RestateContext$1 as RestateContext, type RestateObjectContext$1 as RestateObjectContext, type RestateObjectSharedContext$1 as RestateObjectSharedContext, type RestateWorkflowContext$1 as RestateWorkflowContext, type RestateWorkflowSharedContext$1 as RestateWorkflowSharedContext, type Serde$1 as Serde, type Service$1 as Service, type ServiceDefinition$1 as ServiceDefinition, type ServiceDefinitionFrom$1 as ServiceDefinitionFrom, type ServiceHandler$1 as ServiceHandler, type VirtualObject$1 as VirtualObject, type VirtualObjectDefinition$1 as VirtualObjectDefinition, type VirtualObjectDefinitionFrom$1 as VirtualObjectDefinitionFrom, type Workflow$1 as Workflow, type WorkflowDefinition$1 as WorkflowDefinition, type WorkflowDefinitionFrom$1 as WorkflowDefinitionFrom, type WorkflowHandler$1 as WorkflowHandler, type WorkflowSharedHandler$1 as WorkflowSharedHandler, createObjectHandler, createObjectSharedHandler, createServiceHandler, createWorkflowHandler, createWorkflowSharedHandler, serde$1 as serde };
